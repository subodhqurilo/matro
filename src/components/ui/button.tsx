...
const buttonVariants = cva(
  ...
  text-sm sm:text-base                /* fontsize grows on bigger screens */
  px-3 py-2 sm:px-4 sm:py-2.5 lg:px-6  /* spacing adjusts gracefully */
  md:min-w-[120px] lg:min-w-[140px]    /* button width more stable desktop */ 
  active:scale-[0.98]                  /* click animation */
  `,
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        lg: "h-11 rounded-md has-[>svg]:px-4 text-base",
        icon: "size-9 sm:size-10 lg:size-12",
      },
    },
    defaultVariants: {
      variant: "default",
